  ...
  return (
    <div className="container mx-auto w-full p-4 md:px-8">
      ...
      >
        ...
        {/* Content */}
        <div
          className={`capitalize relative z-10 flex flex-col items-center w-full text-white text-center ${playfairDisplay.className}`}
        >
          ...
          <p>Mariam al kaabi</p>
          <h1 className="font-bold underline mt-2">Director of photogeraphy</h1>
          <p>Syed Ebrahim</p>
