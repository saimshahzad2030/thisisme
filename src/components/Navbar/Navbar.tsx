...
const Navbar = () => {
  ...
  return (
    <div className="fixed container mx-auto w-full z-50">
      <div className="relative flex flex-row items-center justify-between bg-black bg-opacity-90 px-4 py-4">
        ...
        {!menuClicked && (
          ...
          >
            Menu
            <Hamburger className="w-8 h-auto ml-2 " />
          </button>
        )}
        {menuClicked && (
          <div className="fixed top-0 left-0 h-[100vh] w-full bg-black bg-opacity-95 z-50 flex flex-col items-center">
            ...
            <div className="flex flex-row items-center justify-center mt-4">
              <Facebook className="w-8 h-auto text-white mr-2" />
